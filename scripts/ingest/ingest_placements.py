#!/usr/bin/env python
"""Normalize raw placement data (CSV/XLSX) into the canonical offer schema.

Usage:
    python scripts/ingest/ingest_placements.py <input.csv|xlsx> [-o output.csv]
"""
...
DEFAULT_TYPE = "placement"


def normalize(input_path: str | Path) -> list[dict]:
    """Map arbitrary placement CSV/XLSX columns to the offer schema."""
