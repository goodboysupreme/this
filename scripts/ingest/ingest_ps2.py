#!/usr/bin/env python
"""Normalize raw PS-2 station data (CSV/XLSX) into the canonical offer schema.

Usage:
    python scripts/ingest/ingest_ps2.py <input.csv|xlsx> [-o output.csv]
"""
...
def normalize(input_path: str | Path) -> list[dict]:
    """Map arbitrary PS-2 CSV/XLSX columns to the offer schema."""
